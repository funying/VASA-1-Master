...
class AppearanceEncoder(nn.Module):
    def __init__(self):
        ...
        self.res_blocks = nn.Sequential(
            ...
            nn.AvgPool2d(2),
            ResidualBlock2D(512, 1024)
        )
        self.reshaped = nn.Sequential(
            nn.Conv2d(1024, 1024, kernel_size=1, stride=1),
            nn.GroupNorm(num_groups=32, num_channels=1024)  # Ensuring divisible by 32
        )
        self.res3d_blocks = nn.Sequential(
            ResidualBlock3D(128, 96),
